            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-1">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-808px, 0px, 0px); transition: all 1.2s ease 0s; width: 2695px;"><div class="owl-item cloned" style="width: 244.443px; margin-right: 25px;"><div class="product-item">
                        ...
                        </div></div><div class="owl-item cloned" style="width: 244.443px; margin-right: 25px;"><div class="product-item">
                            <div class="pi-pic">
                        ...
                        </div></div><div class="owl-item active" style="width: 244.443px; margin-right: 25px;"><div class="product-item">
                            <div class="pi-pic">
                        ...
                        </div></div><div class="owl-item" style="width: 244.443px; margin-right: 25px;"><div class="product-item">
                            <div class="pi-pic">
                                <img src="img/products/women-4.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                        ...
                        </div></div></div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><i class="ti-angle-left"></i></button><button type="button" role="presentation" class="owl-next"><i class="ti-angle-right"></i></button></div><div class="owl-dots"><button role="button" class="owl-dot active"><span></span></button><button role="button" class="owl-dot"><span></span></button></div></div>
                </div>
            </div>
        </div>
    </section>   
